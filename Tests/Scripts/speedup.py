...
l1=pl.plot(x1,y1,label='Gpu vs cpu single core',color='orange',marker='o', linestyle='dashed')
l2=pl.plot(x2,y2,label='Gpu vs cpu six core',color='red',marker='o',linestyle='dashed')
...
pl.savefig('speedup.pdf',bbox_inches='tight')
pl.show()
